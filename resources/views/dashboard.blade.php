...
<!-- Tab -->
    ...
    <div class="flex justify-center mt-4">
        <ul class="flex flex-wrap text-sm font-medium text-center text-body">
            <li class="me-2">
                <a href="#" 
                class="inline-block px-4 py-2.5 text-white bg-brand rounded-base active"
...
<!-- posts -->
    ...
    <div class="border border-white text-white rounded-md mt-4">
        ...
        <div class="p-6 text-center">
            ...
            <div>
                <a href="#">
            <img class="rounded-lg" src="https://flowbite.com/docs/images/blog/image-1.jpg" alt="{{ $post->title }}" />
            </a>
            </div>
            </div>
